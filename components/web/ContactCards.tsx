...
function ContactCardItem({ card, index }: { card: CardData; index: number }) {
...
export default function ContactCards() {
  const cardsData: CardData[] = [
    ...
    },
    {
      ...
      description: "Still have a question that needs anwering? Send us a message. We're here to help.",
    },
  ];
