...
import { formatSmartDate, ProfileHoverCard } from "./ProfileHoverCard";
...
export function ProfileCard({
  ...
  return (
    ...
    >
      <div className=" flex flex-col gap-2 px-4 py-2 bg-zinc-50/80 dark:bg-zinc-900/80 rounded-xl cursor-pointer transition-colors hover:bg-zinc-100/90 dark:hover:bg-zinc-800/90 [&:has(.no-card-hover:hover)]:bg-zinc-50/80 dark:[&:has(.no-card-hover:hover)]:bg-zinc-900/80">
        <div 
