...
export function LiveMetrics({ views, likes, comments }: LiveMetricsProps) {
  return (
    <div className="flex items-center px-6 text-sm text-muted-foreground font-mono tracking-tight select-none">
