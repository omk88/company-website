...
export default function GridBackground({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div 
      className="min-h-screen w-full bg-white dark:bg-[#030712] transition-colors duration-300 relative overflow-hidden [--line-color:rgba(148,163,184,0.3)] dark:[--line-color:rgba(51,65,85,0.3)]"
    >
