...
export function BlogCTA() {
  return (
    <div className="my-6 p-4 rounded-lg bg-neutral-50 dark:bg-neutral-900/50 border border-neutral-200 dark:border-neutral-800 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
      ...
      <div className="space-y-2 lg:col-span-5 text-center lg:text-left">
        ...
        <p className="text-neutral-500 dark:text-neutral-400 text-sm max-w-md mx-auto lg:mx-0">
        ...
        <div className="pt-2">
          <Link 
            ...
            className={buttonVariants({ 
              variant: "default", 
              size: "sm", 
              className: "gap-2 whitespace-nowrap bg-neutral-950 text-neutral-50 hover:bg-neutral-800 dark:bg-neutral-50 dark:text-neutral-950 dark:hover:bg-neutral-200 shadow-sm transition-colors w-full sm:w-auto" 
            })}
          >
            Explore Products
