export default function Background() {
  return (
    <div className="fixed inset-0 w-screen h-screen pointer-events-none z-[-1] overflow-hidden bg-[#f8f9fa]">
      
      <div 
        className="absolute top-[8%] left-[55%] w-[340px] h-[340px] rounded-full 
      ...
      <div 
        className="absolute bottom-[15%] left-[2%] w-[240px] h-[240px] rounded-full 
