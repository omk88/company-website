  ...
  return (
    <div className="flex flex-col gap-0 w-full overflow-hidden pointer-events-none select-none">
      ...
      <div className="pt-2 px-0.5">
        ...
        <div className="mt-2 h-[3.25rem] flex flex-col justify-start space-y-1.5">
          <Skeleton className="h-5 w-11/12" />
          <Skeleton className="h-5 w-2/3" />
        </div>
      </div>

      <div className="flex flex-row justify-center items-center gap-2 border-border/40 pt-2 pb-2">
