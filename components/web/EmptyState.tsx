  ...
  return (
    <div className="flex flex-1 h-full w-full flex-col items-center justify-center rounded-none p-8 text-center">      
      ...
      <div className="mt-2 max-w-sm md:space-y-1">
        <h3 className="text-lg md:text-base font-bold tracking-tight text-foreground">
          {title}
        </h3>
        <p className="text-base md:text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed">
          {description}
        </p>
      </div>
    </div>
