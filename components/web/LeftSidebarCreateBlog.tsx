            ...
            {isOpen && (
              ...
              >
                ...
                <div className="flex-1 overflow-y-auto space-y-2">
                  <div className="group flex items-center justify-between p-2.5 rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 border border-transparent hover:border-zinc-200 dark:hover:border-zinc-700 cursor-pointer transition-all">
                    <div className="flex items-center gap-2.5 overflow-hidden">
                      <FileText className="w-4 h-4 text-zinc-400 shrink-0" />
                      <div className="truncate">
                        <p className="text-xs font-medium text-zinc-800 dark:text-zinc-200 truncate">Untitled Post</p>
                        <p className="text-[10px] text-zinc-400">Edited 2m ago</p>
                      </div>
                    </div>
                    <Button 
                      variant="ghost" 
