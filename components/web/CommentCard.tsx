...
export function CommentCard({ comment, index }: CommentProps) {
    return (
        <div className="flex flex-col gap-4">
            <div className="flex flex-col items-start border-2 p-4">
                ...
                <h2 className="font-bold">{comment.authorName} • {new Date(comment._creationTime).toLocaleDateString("en-US")}</h2>
