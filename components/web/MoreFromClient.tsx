...
interface MoreFromClientProps {
    initialBlogs: BlogPostPreview[];
}

export function MoreFromClient({ initialBlogs }: MoreFromClientProps) {
    if (initialBlogs.length === 0) {
        return <p className="text-sm text-muted-foreground p-2">No posts.</p>;
    }
