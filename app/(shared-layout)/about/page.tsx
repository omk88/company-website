    ...
    <>
      <div className="max-w-6xl mx-auto w-full border-x border-neutral-200 dark:border-neutral-800 flex-1">
        ...
        <div className="flex flex-col items-center mt-16 text-center gap-4 py-10">
          ...
          <div className="flex flex-col items-center w-full my-12 py-6 border-y border-neutral-200/80 dark:border-neutral-800/80 text-neutral-600 dark:text-neutral-400">
            <h1
              className={cn(
                "py-6",
