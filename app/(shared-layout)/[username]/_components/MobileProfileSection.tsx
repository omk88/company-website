...
export function MobileProfileSection({ preloadedProfile, preloadedCurrentUser }: MobileProfileSectionProps) {
  ...
  return (
    <div className="flex flex-col gap-4 p-2 h-fit border-b bg-zinc-50/80 dark:bg-zinc-900/50 w-full relative">
      {isOwnProfile && (
        <div className="flex flex-row gap-2 absolute -top-1 -right-1 p-4 items-center z-10">
      ...
      {hasExpandableContent && (
        <div className="flex flex-col gap-2">
          ...
          <div
            className={cn(
              "grid transition-all duration-300 ease-in-out contain-layout transform-gpu",
